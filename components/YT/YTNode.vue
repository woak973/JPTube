  ...
  <template v-if="data">
    ...
    <template v-else-if="data.type === 'Shelf'">
      <v-col cols="12">
        <template v-if="(data as YTNodes.Shelf).title.text || (data as YTNodes.Shelf).subtitle?.text">
          <v-card
            :to="(data as YTNodes.Shelf).endpoint?.metadata.url"
            :link="!!(data as YTNodes.Shelf).endpoint?.metadata.url">
            <v-card-title>
    ...
    <template v-else-if="data.type === 'HorizontalList'">
      <v-col cols="12">
        <v-slide-group>
          <div
            v-for="content in (data as YTNodes.HorizontalList).contents" class="ma-2"
    ...
    <template v-else-if="data.type === 'ReelShelf'">
      <v-col cols="12">
        ...
        <v-slide-group>
          <div
            v-for="item in (data as YTNodes.ReelShelf).items" class="ma-2"
    ...
    <template v-else-if="data.type === 'RichShelf'">
      <v-col cols="12">
        ...
        <v-slide-group>
          <div
            v-for="content in (data as YTNodes.RichShelf).contents" class="ma-2"
            :style="{ width: (content.type === 'Post' || (content instanceof YTNodes.RichItem && content.content.type === 'Post')) ? '500px' : '200px' }">
            <template v-if="(content instanceof Helpers.YTNode)">
              <YTNode :data="content" :attribute="'slide'" :page="page" />
            </template>
